...
# Perform BFS on path, cycle, sparse, tree, complete, and bipartite graphs with different number of nodes and plot the graphs
def perform_bfs_and_plot_graphs():
    ...
    for num_nodes in nodes_list:
        ...
        visited = graph.bfs(start_node)
        end_time = time.time()
        print("Visited Nodes after BFS in Path Graph:", visited)
        ...
        visited = graph.bfs(start_node)
        end_time = time.time()
        print("\nVisited Nodes after BFS in Cycle Graph:", visited)
        ...
        visited = graph.bfs(start_node)
        end_time = time.time()
        print("\nVisited Nodes after BFS in Sparse Graph:", visited)
        ...
        visited = graph.bfs(start_node)
        end_time = time.time()
        print("\nVisited Nodes after BFS in Tree Graph:", visited)
        ...
        visited = graph.bfs(start_node)
        end_time = time.time()
        print("\nVisited Nodes after BFS in Complete Graph:", visited)
        ...
        visited = graph.bfs(start_node)
        end_time = time.time()
        print("\nVisited Nodes after BFS in Bipartite Graph:", visited)
        print("Execution Time for Bipartite Graph:", end_time - start_time, "seconds")

# Call the function
perform_bfs_and_plot_graphs()